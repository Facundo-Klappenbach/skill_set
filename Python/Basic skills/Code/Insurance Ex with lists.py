...
insurance_cost_difference = [(estimated_insurance_data[0][0], estimated_insurance_data[0][1]- insurance_data[0][1]), (estimated_insurance_data[1][0], estimated_insurance_data[1][1]- insurance_data[1][1]),( estimated_insurance_data[2][0], estimated_insurance_data[2][1]- insurance_data[2][1]),( estimated_insurance_data[3][0], estimated_insurance_data[3][1]- insurance_data[3][1])]
